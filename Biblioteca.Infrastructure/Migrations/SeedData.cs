    ...
    public class SeedData
    {
        public static async Task Initialize(BibilotecaDbContext context, UserManager<IdentityUser> userManager)
        {
            if (!userManager.Users.Any())
            {
                ...
                await userManager.AddToRoleAsync(admin, "EsAdmin");
                ...
                await userManager.AddToRoleAsync(usuario, "EsEmpleado");
                ...
                await userManager.AddToRoleAsync(cliente, "EsCliente");

                // Agregar claims a los usuarios
